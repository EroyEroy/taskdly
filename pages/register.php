			...
			<div class="preparation">
				...
				<div class="preparation__info">
					...
					<h2 class="preparation__subtitle">
						Зарегистрируйтесь в пару кликов и <br> приступайте к делу!
					</h2>
					<!-- картинка -->
					<img class="preparation__img" src="img/human2.png" alt="">
				</div>
				...
				<form class="preparation__form">
					...
					<input class="preparation__input" name="passwordConfirm" type="password" placeholder="Повторите пароль" required>
					<div class="notification">
					</div>
					<!-- кнопка входа в аккаунт -->
					<button class="preparation__button">
						Зарегистрироваться
					</button>
					...
					<div class="preparation__bottom">
						...
						<a class="preparation__link" href="login">
							Войти
						</a>
					</div>
				</form>
